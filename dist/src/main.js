import { createTaskAndMonitor, login, logout, resumeTask, showStatus } from "./commands.js";
import { c, printHelp, showCursor } from "./ui.js";
export async function main() {
    ...
    if (command === "resume") {
        const taskId = args[1];
        if (!taskId)
            throw new Error("Usage: auditor resume <taskId>");
